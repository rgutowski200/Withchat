...
TAX_DISCLAIMER = (
    "Federal tax estimates are simplified and educational only. They do not include "
    "capital gains treatment, itemized deductions, tax credits, state or local taxes, "
    "IRMAA, Medicare surtaxes, early withdrawal penalties, or other individualized tax factors. "
    "Consult a qualified tax professional before making retirement, withdrawal, or Roth conversion decisions."
)
...
def tax_assumption_note():
    ...
    return (
        ...
        "The estimate includes taxable Social Security using provisional income thresholds and includes taxable Social Security in federal taxable income. "
        + TAX_DISCLAIMER
    )
...
def build_pdf_report(df):
    ...
    story.append(Paragraph("<b>Important Tax Note:</b> " + tax_assumption_note(), small))
